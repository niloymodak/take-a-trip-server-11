...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.hagnwzq.mongodb.net/?retryWrites=true&w=majority`;
...
app.get('/', (req, res) => {
    res.send('Online Service Running!')
})

app.listen(port, () => {
    console.log(`Online Service Running on port ${port}`)
})